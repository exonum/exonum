...
#[derive(Debug, ServiceFactory, ServiceDispatcher)]
#[service_dispatcher(implements("Withdrawal"))]
#[service_factory(artifact_name = "withdrawal", artifact_version = "0.3.0")]
struct WithdrawalServiceV3;

impl Withdrawal<ExecutionContext<'_>> for WithdrawalServiceV3 {
    type Output = Result<(), ExecutionError>;
...
impl Service for WithdrawalServiceV3 {
    fn initialize(
        &self,
        context: ExecutionContext<'_>,
        params: Vec<u8>,
...
impl DefaultInstance for WithdrawalServiceV3 {
    const INSTANCE_ID: u32 = 2;
    const INSTANCE_NAME: &'static str = "withdrawal";
