...
describe('Interaction with blockchain', () => {
  ...
  it('should get timestamp proof and verify it', async () => {
    ...
    await expect(Vue.prototype.$blockchain.getTimestampProof(hash)).resolves.toEqual({
      ...
      'timestamp': {
        'content_hash': {
          'data': [12, 244, 253, 22, 52, 188, 182, 224, 207, 192, 174, 14, 17, 25, 49, 116, 124, 129, 246, 19, 83, 74, 102, 190, 143, 142, 192, 235, 14, 209, 172, 249]
        },
        'metadata': 'Some contract'
      },
      'tx_hash': {
        'data': [206, 7, 67, 207, 246, 189, 239, 10, 250, 47, 58, 246, 139, 119, 97, 42, 168, 242, 33, 144, 211, 233, 69, 52, 38, 142, 59, 120, 76, 253, 120, 5]
      }
    })
  })
})
