...
(function(global, factory) { /* global define, require, module */
    ...
    $root.exonum = (function() {
        ...
        exonum.examples = (function() {
            ...
            examples.timestamping = (function() {
                ...
                timestamping.Timestamp = (function() {
    
                    /**
                     * Properties of a Timestamp.
                     * @memberof exonum.examples.timestamping
                     * @interface ITimestamp
                     * @property {exonum.IHash|null} [contentHash] Timestamp contentHash
                     * @property {string|null} [metadata] Timestamp metadata
                     */
                     ...
                     * @constructor
                     * @param {exonum.examples.timestamping.ITimestamp=} [properties] Properties to set
                     */
                     ...
                     * @member {exonum.IHash|null|undefined} contentHash
                     * @memberof exonum.examples.timestamping.Timestamp
                     * @instance
                     */
                    Timestamp.prototype.contentHash = null;
                     ...
                     * @static
                     * @param {exonum.examples.timestamping.ITimestamp=} [properties] Properties to set
                     * @returns {exonum.examples.timestamping.Timestamp} Timestamp instance
                     */
                    ...
                    /**
                     * Encodes the specified Timestamp message. Does not implicitly {@link exonum.examples.timestamping.Timestamp.verify|verify} messages.
                     * @function encode
                     * @memberof exonum.examples.timestamping.Timestamp
                     * @static
                     * @param {exonum.examples.timestamping.ITimestamp} message Timestamp message or plain object to encode
                     * @param {$protobuf.Writer} [writer] Writer to encode to
                     * @returns {$protobuf.Writer} Writer
                     */
                    Timestamp.encode = function encode(message, writer) {
                        ...
                        if (message.contentHash != null && message.hasOwnProperty("contentHash"))
                            $root.exonum.Hash.encode(message.contentHash, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                    ...
                    /**
                     * Encodes the specified Timestamp message, length delimited. Does not implicitly {@link exonum.examples.timestamping.Timestamp.verify|verify} messages.
                     * @function encodeDelimited
                     * @memberof exonum.examples.timestamping.Timestamp
                     * @static
                     * @param {exonum.examples.timestamping.ITimestamp} message Timestamp message or plain object to encode
                     ...
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     * @param {number} [length] Message length if known beforehand
                     * @returns {exonum.examples.timestamping.Timestamp} Timestamp
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    Timestamp.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.exonum.examples.timestamping.Timestamp();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1:
                                message.contentHash = $root.exonum.Hash.decode(reader, reader.uint32());
                                break;
                            case 2:
                    ...
                    Timestamp.verify = function verify(message) {
                        if (typeof message !== "object" || message === null)
                            return "object expected";
                        if (message.contentHash != null && message.hasOwnProperty("contentHash")) {
                            var error = $root.exonum.Hash.verify(message.contentHash);
                            if (error)
                    ...
                    Timestamp.fromObject = function fromObject(object) {
                        if (object instanceof $root.exonum.examples.timestamping.Timestamp)
                            return object;
                        var message = new $root.exonum.examples.timestamping.Timestamp();
                        if (object.contentHash != null) {
                            if (typeof object.contentHash !== "object")
                                throw TypeError(".exonum.examples.timestamping.Timestamp.contentHash: object expected");
                            message.contentHash = $root.exonum.Hash.fromObject(object.contentHash);
                        }
                     ...
                     * @memberof exonum.examples.timestamping.Timestamp
                     * @static
                     * @param {exonum.examples.timestamping.Timestamp} message Timestamp
                     * @param {$protobuf.IConversionOptions} [options] Conversion options
                     * @returns {Object.<string,*>} Plain object
                     */
                    Timestamp.toObject = function toObject(message, options) {
                        ...
                        if (message.contentHash != null && message.hasOwnProperty("contentHash"))
                            object.contentHash = $root.exonum.Hash.toObject(message.contentHash, options);
                        if (message.metadata != null && message.hasOwnProperty("metadata"))
                ...
                timestamping.TimestampEntry = (function() {
    
                    /**
                     * Properties of a TimestampEntry.
                     * @memberof exonum.examples.timestamping
                     * @interface ITimestampEntry
                     * @property {exonum.examples.timestamping.ITimestamp|null} [timestamp] TimestampEntry timestamp
                     * @property {exonum.IHash|null} [txHash] TimestampEntry txHash
                     * @property {google.protobuf.ITimestamp|null} [time] TimestampEntry time
                     */
    
                    /**
                     * Constructs a new TimestampEntry.
                     * @memberof exonum.examples.timestamping
                     * @classdesc Represents a TimestampEntry.
                     * @implements ITimestampEntry
                     * @constructor
                     * @param {exonum.examples.timestamping.ITimestampEntry=} [properties] Properties to set
                     */
                    function TimestampEntry(properties) {
                        if (properties)
                            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                                if (properties[keys[i]] != null)
                                    this[keys[i]] = properties[keys[i]];
                     ...
                     * @member {exonum.examples.timestamping.ITimestamp|null|undefined} timestamp
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @instance
                     */
                    TimestampEntry.prototype.timestamp = null;
    
                    /**
                     * TimestampEntry txHash.
                     * @member {exonum.IHash|null|undefined} txHash
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @instance
                     */
                    TimestampEntry.prototype.txHash = null;
                     ...
                     * @instance
                     */
                    TimestampEntry.prototype.time = null;
    
                    /**
                     * Creates a new TimestampEntry instance using the specified properties.
                     * @function create
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @static
                     * @param {exonum.examples.timestamping.ITimestampEntry=} [properties] Properties to set
                     * @returns {exonum.examples.timestamping.TimestampEntry} TimestampEntry instance
                     */
                    TimestampEntry.create = function create(properties) {
                        return new TimestampEntry(properties);
                    };
    
                    /**
                     * Encodes the specified TimestampEntry message. Does not implicitly {@link exonum.examples.timestamping.TimestampEntry.verify|verify} messages.
                     * @function encode
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @static
                     * @param {exonum.examples.timestamping.ITimestampEntry} message TimestampEntry message or plain object to encode
                     * @param {$protobuf.Writer} [writer] Writer to encode to
                     * @returns {$protobuf.Writer} Writer
                     */
                    TimestampEntry.encode = function encode(message, writer) {
                        if (!writer)
                            writer = $Writer.create();
                        if (message.timestamp != null && message.hasOwnProperty("timestamp"))
                            $root.exonum.examples.timestamping.Timestamp.encode(message.timestamp, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                        if (message.txHash != null && message.hasOwnProperty("txHash"))
                            $root.exonum.Hash.encode(message.txHash, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                        if (message.time != null && message.hasOwnProperty("time"))
                    ...
                    /**
                     * Encodes the specified TimestampEntry message, length delimited. Does not implicitly {@link exonum.examples.timestamping.TimestampEntry.verify|verify} messages.
                     * @function encodeDelimited
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @static
                     * @param {exonum.examples.timestamping.ITimestampEntry} message TimestampEntry message or plain object to encode
                     ...
                     * @returns {$protobuf.Writer} Writer
                     */
                    TimestampEntry.encodeDelimited = function encodeDelimited(message, writer) {
                        return this.encode(message, writer).ldelim();
                    };
    
                    /**
                     * Decodes a TimestampEntry message from the specified reader or buffer.
                     * @function decode
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @static
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     * @param {number} [length] Message length if known beforehand
                     * @returns {exonum.examples.timestamping.TimestampEntry} TimestampEntry
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    TimestampEntry.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.exonum.examples.timestamping.TimestampEntry();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1:
                                message.timestamp = $root.exonum.examples.timestamping.Timestamp.decode(reader, reader.uint32());
                                break;
                            case 2:
                                message.txHash = $root.exonum.Hash.decode(reader, reader.uint32());
                                break;
                    ...
                    /**
                     * Decodes a TimestampEntry message from the specified reader or buffer, length delimited.
                     * @function decodeDelimited
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @static
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     ...
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    TimestampEntry.decodeDelimited = function decodeDelimited(reader) {
                        if (!(reader instanceof $Reader))
                            reader = new $Reader(reader);
                        return this.decode(reader, reader.uint32());
                    };
                    ...
                    /**
                     * Verifies a TimestampEntry message.
                     * @function verify
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @static
                     * @param {Object.<string,*>} message Plain object to verify
                     * @returns {string|null} `null` if valid, otherwise the reason why it is not
                     */
                    TimestampEntry.verify = function verify(message) {
                        if (typeof message !== "object" || message === null)
                            return "object expected";
                        if (message.timestamp != null && message.hasOwnProperty("timestamp")) {
                            var error = $root.exonum.examples.timestamping.Timestamp.verify(message.timestamp);
                            if (error)
                    ...
                    /**
                     * Creates a TimestampEntry message from a plain object. Also converts values to their respective internal types.
                     * @function fromObject
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @static
                     * @param {Object.<string,*>} object Plain object
                     * @returns {exonum.examples.timestamping.TimestampEntry} TimestampEntry
                     */
                    TimestampEntry.fromObject = function fromObject(object) {
                        if (object instanceof $root.exonum.examples.timestamping.TimestampEntry)
                            return object;
                        var message = new $root.exonum.examples.timestamping.TimestampEntry();
                        if (object.timestamp != null) {
                            if (typeof object.timestamp !== "object")
                                throw TypeError(".exonum.examples.timestamping.TimestampEntry.timestamp: object expected");
                            message.timestamp = $root.exonum.examples.timestamping.Timestamp.fromObject(object.timestamp);
                        }
                        if (object.txHash != null) {
                            if (typeof object.txHash !== "object")
                                throw TypeError(".exonum.examples.timestamping.TimestampEntry.txHash: object expected");
                            message.txHash = $root.exonum.Hash.fromObject(object.txHash);
                        }
                        if (object.time != null) {
                            if (typeof object.time !== "object")
                                throw TypeError(".exonum.examples.timestamping.TimestampEntry.time: object expected");
                            message.time = $root.google.protobuf.Timestamp.fromObject(object.time);
                        }
                        return message;
                    };
                    ...
                    /**
                     * Creates a plain object from a TimestampEntry message. Also converts values to other types if specified.
                     * @function toObject
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @static
                     * @param {exonum.examples.timestamping.TimestampEntry} message TimestampEntry
                     * @param {$protobuf.IConversionOptions} [options] Conversion options
                     * @returns {Object.<string,*>} Plain object
                     */
                    TimestampEntry.toObject = function toObject(message, options) {
                        if (!options)
                            options = {};
                        var object = {};
                        if (options.defaults) {
                        ...
                        if (message.timestamp != null && message.hasOwnProperty("timestamp"))
                            object.timestamp = $root.exonum.examples.timestamping.Timestamp.toObject(message.timestamp, options);
                        if (message.txHash != null && message.hasOwnProperty("txHash"))
                            object.txHash = $root.exonum.Hash.toObject(message.txHash, options);
                        if (message.time != null && message.hasOwnProperty("time"))
                            object.time = $root.google.protobuf.Timestamp.toObject(message.time, options);
                    ...
                    /**
                     * Converts this TimestampEntry to JSON.
                     * @function toJSON
                     * @memberof exonum.examples.timestamping.TimestampEntry
                     * @instance
                     * @returns {Object.<string,*>} JSON object
                     */
                    TimestampEntry.prototype.toJSON = function toJSON() {
                        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                    };
                ...
                timestamping.TxTimestamp = (function() {
    
                    /**
                     * Properties of a TxTimestamp.
                     * @memberof exonum.examples.timestamping
                     * @interface ITxTimestamp
                     * @property {exonum.examples.timestamping.ITimestamp|null} [content] Timestamping transaction.
                     */
    
                    /**
                     * Constructs a new TxTimestamp.
                     * @memberof exonum.examples.timestamping
                     * @classdesc Timestamping transaction.
                     * @implements ITxTimestamp
                     * @constructor
                     * @param {exonum.examples.timestamping.ITxTimestamp=} [properties] Properties to set
                     */
                    function TxTimestamp(properties) {
                        if (properties)
                            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                                if (properties[keys[i]] != null)
                                    this[keys[i]] = properties[keys[i]];
                     ...
                     * @member {exonum.examples.timestamping.ITimestamp|null|undefined} content
                     * @memberof exonum.examples.timestamping.TxTimestamp
                     * @instance
                     */
                    TxTimestamp.prototype.content = null;
    
                    /**
                     * Creates a new TxTimestamp instance using the specified properties.
                     * @function create
                     * @memberof exonum.examples.timestamping.TxTimestamp
                     * @static
                     * @param {exonum.examples.timestamping.ITxTimestamp=} [properties] Properties to set
                     * @returns {exonum.examples.timestamping.TxTimestamp} TxTimestamp instance
                     */
                    TxTimestamp.create = function create(properties) {
                        return new TxTimestamp(properties);
                    };
    
                    /**
                     * Encodes the specified TxTimestamp message. Does not implicitly {@link exonum.examples.timestamping.TxTimestamp.verify|verify} messages.
                     * @function encode
                     * @memberof exonum.examples.timestamping.TxTimestamp
                     * @static
                     * @param {exonum.examples.timestamping.ITxTimestamp} message TxTimestamp message or plain object to encode
                     * @param {$protobuf.Writer} [writer] Writer to encode to
                     * @returns {$protobuf.Writer} Writer
                     */
                    TxTimestamp.encode = function encode(message, writer) {
                        if (!writer)
                            writer = $Writer.create();
                        if (message.content != null && message.hasOwnProperty("content"))
                            $root.exonum.examples.timestamping.Timestamp.encode(message.content, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                        return writer;
                    };
    
                    /**
                     * Encodes the specified TxTimestamp message, length delimited. Does not implicitly {@link exonum.examples.timestamping.TxTimestamp.verify|verify} messages.
                     * @function encodeDelimited
                     * @memberof exonum.examples.timestamping.TxTimestamp
                     * @static
                     * @param {exonum.examples.timestamping.ITxTimestamp} message TxTimestamp message or plain object to encode
                     ...
                     * @returns {$protobuf.Writer} Writer
                     */
                    TxTimestamp.encodeDelimited = function encodeDelimited(message, writer) {
                        return this.encode(message, writer).ldelim();
                    };
    
                    /**
                     * Decodes a TxTimestamp message from the specified reader or buffer.
                     * @function decode
                     * @memberof exonum.examples.timestamping.TxTimestamp
                     * @static
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     * @param {number} [length] Message length if known beforehand
                     * @returns {exonum.examples.timestamping.TxTimestamp} TxTimestamp
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    TxTimestamp.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.exonum.examples.timestamping.TxTimestamp();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1:
                                message.content = $root.exonum.examples.timestamping.Timestamp.decode(reader, reader.uint32());
                                break;
                            default:
                                reader.skipType(tag & 7);
                                break;
                    ...
                    /**
                     * Decodes a TxTimestamp message from the specified reader or buffer, length delimited.
                     * @function decodeDelimited
                     * @memberof exonum.examples.timestamping.TxTimestamp
                     * @static
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     ...
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    TxTimestamp.decodeDelimited = function decodeDelimited(reader) {
                        if (!(reader instanceof $Reader))
                            reader = new $Reader(reader);
                        return this.decode(reader, reader.uint32());
                    };
                    ...
                    /**
                     * Verifies a TxTimestamp message.
                     * @function verify
                     * @memberof exonum.examples.timestamping.TxTimestamp
                     * @static
                     * @param {Object.<string,*>} message Plain object to verify
                     * @returns {string|null} `null` if valid, otherwise the reason why it is not
                     */
                    TxTimestamp.verify = function verify(message) {
                        if (typeof message !== "object" || message === null)
                            return "object expected";
                        if (message.content != null && message.hasOwnProperty("content")) {
                            var error = $root.exonum.examples.timestamping.Timestamp.verify(message.content);
                            if (error)
                    ...
                    /**
                     * Creates a TxTimestamp message from a plain object. Also converts values to their respective internal types.
                     * @function fromObject
                     * @memberof exonum.examples.timestamping.TxTimestamp
                     * @static
                     * @param {Object.<string,*>} object Plain object
                     * @returns {exonum.examples.timestamping.TxTimestamp} TxTimestamp
                     */
                    TxTimestamp.fromObject = function fromObject(object) {
                        if (object instanceof $root.exonum.examples.timestamping.TxTimestamp)
                            return object;
                        var message = new $root.exonum.examples.timestamping.TxTimestamp();
                        if (object.content != null) {
                            if (typeof object.content !== "object")
                                throw TypeError(".exonum.examples.timestamping.TxTimestamp.content: object expected");
                            message.content = $root.exonum.examples.timestamping.Timestamp.fromObject(object.content);
                        }
                        return message;
                    };
    
                    /**
                     * Creates a plain object from a TxTimestamp message. Also converts values to other types if specified.
                     * @function toObject
                     * @memberof exonum.examples.timestamping.TxTimestamp
                     * @static
                     * @param {exonum.examples.timestamping.TxTimestamp} message TxTimestamp
                     * @param {$protobuf.IConversionOptions} [options] Conversion options
                     * @returns {Object.<string,*>} Plain object
                     */
                    TxTimestamp.toObject = function toObject(message, options) {
                        if (!options)
                            options = {};
                        var object = {};
                        if (options.defaults)
                            object.content = null;
                        if (message.content != null && message.hasOwnProperty("content"))
                            object.content = $root.exonum.examples.timestamping.Timestamp.toObject(message.content, options);
                        return object;
                    };
    
                    /**
                     * Converts this TxTimestamp to JSON.
                     * @function toJSON
                     * @memberof exonum.examples.timestamping.TxTimestamp
                     * @instance
                     * @returns {Object.<string,*>} JSON object
                     */
                    TxTimestamp.prototype.toJSON = function toJSON() {
                        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                    };
