    ...
    V: BinaryValue,
{
    ...
    /// let fork = db.fork();
    /// let mut index = fork.as_ref().ensure_proof_map("name");
    ///
    ...
    /// let db = TemporaryDB::new();
    /// let fork = db.fork();
    /// let index = fork.as_ref().ensure_proof_map::<_, Hash, u8>("name");
    ///
    ...
    /// let db = TemporaryDB::new();
    /// let fork = db.fork();
    /// let index = fork.as_ref().ensure_proof_map::<_, String, u8>("name");
    ///
