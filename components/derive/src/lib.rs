...
///
/// * `#[exonum(interfaces ( default = "path" ))]`
///
/// Path to the corresponding service interface trait which marked by the `exonum_service` attribute.
///
/// ## Optional
///
/// * `#[exonum(crate = "path")]`
...
///     interfaces ( default = "TimeServiceInterface" ),
/// )]
