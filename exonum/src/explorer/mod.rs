...
//impl<T> Serialize for CommittedTransaction<T> where T: Serialize{
//    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
//        where S: Serializer
//    {
//        //unimplemented!()
//        let mut structure = serializer.serialize_struct("CommittedTransaction", 4)?;
//        structure.serialize_field("content", &self.content)?;
//        structure.serialize_field("location", &self.location)?;
//        structure.serialize_field("location_proof", &self.location_proof)?;
//        structure.serialize_field("status", &self.status)?;
//        structure.end()
//    }
//}
//
//impl<'de, T> Deserialize<'de> for CommittedTransaction<T> where T: Deserialize<'de> {
...
//impl<T> Serialize for TransactionInfo<Box<T>> where for<'a> &'a T: Serialize {
//    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
//    where S: Serializer
//    {
