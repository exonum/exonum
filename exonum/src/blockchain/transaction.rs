...
//impl <'a> Serialize for Box<Transaction + 'a> {
//    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
//        where S: Serializer
//    {
//        serialize_with_erased(self.as_ref(), serializer)
//    }
//}

//impl<'a, T: From<&'a Transaction>> Serialize for T {
//    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where
//        S: Serializer {
//        serialize_with_erased(self.into(), serializer)
//    }
//}
