...
Смотри пункт DRM Demo. С той разнией, что для установки локально нет необходимости настраивать домен.

Для тобы собрать файлы для выгрузки в продакшн, полностью аналогично DRM Demo, запускаем:
